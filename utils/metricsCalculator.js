module.exports = class MetricsCalculator {
  ...
  get roi_today() {
    if (!this.total_spent) return 0
    return (this.revenue_today - this.total_spent) / this.total_spent * 100
  }
  get roi_yesterday() {
    if (!this.total_spent) return 0
    return (this.revenue_yesterday - this.total_spent) / this.total_spent * 100
  }
  get roi_2_days_ago() {
    if (!this.total_spent) return 0
    return (this.revenue_2_days_ago - this.total_spent) / this.total_spent * 100
  }
  get roi_3_days_ago() {
    if (!this.total_spent) return 0
    return (this.revenue_3_days_ago - this.total_spent) / this.total_spent * 100
  }
